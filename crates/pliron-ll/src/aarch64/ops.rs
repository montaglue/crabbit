...
define_aarch64_instructions! {
    ...
    FabsD => FabsDOp, "aarch64.fabs_d", "fabs_d", [ATTR_KEY_AARCH64_RD => Def, ATTR_KEY_AARCH64_RN => Use];
    FabsS => FabsSOp, "aarch64.fabs_s", "fabs_s", [ATTR_KEY_AARCH64_RD => Def, ATTR_KEY_AARCH64_RN => Use];
    FsqrtD => FsqrtDOp, "aarch64.fsqrt_d", "fsqrt_d", [ATTR_KEY_AARCH64_RD => Def, ATTR_KEY_AARCH64_RN => Use];
    FsqrtS => FsqrtSOp, "aarch64.fsqrt_s", "fsqrt_s", [ATTR_KEY_AARCH64_RD => Def, ATTR_KEY_AARCH64_RN => Use];
    FrintmD => FrintmDOp, "aarch64.frintm_d", "frintm_d", [ATTR_KEY_AARCH64_RD => Def, ATTR_KEY_AARCH64_RN => Use];
    FrintmS => FrintmSOp, "aarch64.frintm_s", "frintm_s", [ATTR_KEY_AARCH64_RD => Def, ATTR_KEY_AARCH64_RN => Use];
    FrintpD => FrintpDOp, "aarch64.frintp_d", "frintp_d", [ATTR_KEY_AARCH64_RD => Def, ATTR_KEY_AARCH64_RN => Use];
    FrintpS => FrintpSOp, "aarch64.frintp_s", "frintp_s", [ATTR_KEY_AARCH64_RD => Def, ATTR_KEY_AARCH64_RN => Use];
    FrintzD => FrintzDOp, "aarch64.frintz_d", "frintz_d", [ATTR_KEY_AARCH64_RD => Def, ATTR_KEY_AARCH64_RN => Use];
    FrintzS => FrintzSOp, "aarch64.frintz_s", "frintz_s", [ATTR_KEY_AARCH64_RD => Def, ATTR_KEY_AARCH64_RN => Use];
    FrintaD => FrintaDOp, "aarch64.frinta_d", "frinta_d", [ATTR_KEY_AARCH64_RD => Def, ATTR_KEY_AARCH64_RN => Use];
    FrintaS => FrintaSOp, "aarch64.frinta_s", "frinta_s", [ATTR_KEY_AARCH64_RD => Def, ATTR_KEY_AARCH64_RN => Use];
    FrintnD => FrintnDOp, "aarch64.frintn_d", "frintn_d", [ATTR_KEY_AARCH64_RD => Def, ATTR_KEY_AARCH64_RN => Use];
    FrintnS => FrintnSOp, "aarch64.frintn_s", "frintn_s", [ATTR_KEY_AARCH64_RD => Def, ATTR_KEY_AARCH64_RN => Use];
    FminnmD => FminnmDOp, "aarch64.fminnm_d", "fminnm_d", [ATTR_KEY_AARCH64_RD => Def, ATTR_KEY_AARCH64_RN => Use, ATTR_KEY_AARCH64_RM => Use];
    FminnmS => FminnmSOp, "aarch64.fminnm_s", "fminnm_s", [ATTR_KEY_AARCH64_RD => Def, ATTR_KEY_AARCH64_RN => Use, ATTR_KEY_AARCH64_RM => Use];
    FmaxnmD => FmaxnmDOp, "aarch64.fmaxnm_d", "fmaxnm_d", [ATTR_KEY_AARCH64_RD => Def, ATTR_KEY_AARCH64_RN => Use, ATTR_KEY_AARCH64_RM => Use];
    FmaxnmS => FmaxnmSOp, "aarch64.fmaxnm_s", "fmaxnm_s", [ATTR_KEY_AARCH64_RD => Def, ATTR_KEY_AARCH64_RN => Use, ATTR_KEY_AARCH64_RM => Use];
    FminD => FminDOp, "aarch64.fmin_d", "fmin_d", [ATTR_KEY_AARCH64_RD => Def, ATTR_KEY_AARCH64_RN => Use, ATTR_KEY_AARCH64_RM => Use];
    FminS => FminSOp, "aarch64.fmin_s", "fmin_s", [ATTR_KEY_AARCH64_RD => Def, ATTR_KEY_AARCH64_RN => Use, ATTR_KEY_AARCH64_RM => Use];
    FmaxD => FmaxDOp, "aarch64.fmax_d", "fmax_d", [ATTR_KEY_AARCH64_RD => Def, ATTR_KEY_AARCH64_RN => Use, ATTR_KEY_AARCH64_RM => Use];
    FmaxS => FmaxSOp, "aarch64.fmax_s", "fmax_s", [ATTR_KEY_AARCH64_RD => Def, ATTR_KEY_AARCH64_RN => Use, ATTR_KEY_AARCH64_RM => Use];
